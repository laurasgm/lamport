...
'''Laura Sophia G'''
'''https://github.com/4a75616e/bakery/blob/master/bakery.py
   https://github.com/samuelmartingc/Lamport_panaderia_java7/blob/master/Museo_n_personas_panaderia_Lamport/src/Main_Museo.java'''
